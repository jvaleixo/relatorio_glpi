...
COLUNA_DATA = 'Data de fechamento'                  # Nome da coluna com a data
...
# Personalização
plt.title(f'Chamados GLPI Fechados por Dia e Média Mensal - {hoje.year}')
plt.xlabel('Data')
...
plt.savefig('/home/aleixo/Documents/pcantigo/Documents/estatistica-glpi/relatorio_mensal/graficos/chamados_com_media_mensal_fechado.png')
plt.savefig(f'/home/aleixo/Documents/pcantigo/Documents/estatistica-glpi/relatorio_mensal/graficos/chamados_com_media_mensal_fechado_{labels}_{hoje.year}.png')
