...
caminho_csv = '/home/aleixo/Documents/pcantigo/Documents/estatistica-glpi/relatorio_mensal/glpi_mudancas/mudancas.csv'
...
etiquetas_alvo = ['Aprovação', 'Testando', 'Aceito', 'Pendente','Revisão','Fechado', 'Cancelado']  # Edite conforme necessário
...
contagem_ordenada = dict(sorted(contagem_resultado.items(), key=lambda item: item[1], reverse=False))			
...
plt.title(f'Contagem de status Implantação')
plt.xlabel("Status")
plt.ylabel("Frequência")
plt.gca().invert_xaxis()
plt.tight_layout()
plt.grid(axis='y', linestyle='--', alpha=0.6)
plt.savefig('/home/aleixo/Documents/pcantigo/Documents/estatistica-glpi/relatorio_mensal/graficos_mudancas/chamados_contador_status.png')
plt.savefig(f'/home/aleixo/Documents/pcantigo/Documents/estatistica-glpi/relatorio_mensal/graficos_mudancas/chamados_contador_status_{labels}_{hoje.year}.png')
