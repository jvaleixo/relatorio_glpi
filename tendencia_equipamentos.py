...
equipamentos = ['GW', 'MDX', 'SOLARIMÉTRICA', 'UTR', 'TRACKER', 'INV', 'SW']  # Edite conforme necessário
...
plt.annotate('Nova versão dos gateways - 09/04/25',
             ...
             color='black')
plt.savefig('/home/aleixo/Documents/pcantigo/Documents/estatistica-glpi/relatorio_mensal/graficos/tendencia_equipamentos.png')
plt.savefig(f'/home/aleixo/Documents/pcantigo/Documents/estatistica-glpi/relatorio_mensal/graficos/tendencia_equipamentos_{labels}_{hoje.year}.png')
