...
COLUNA_DATA = 'Data da solução'                  # Nome da coluna com a data
...
# Personalização
plt.title(f'Chamados GLPI solucionados por Dia e Média Mensal - {hoje.year}')
plt.xlabel('Data')
...
plt.savefig('/home/aleixo/Documents/pcantigo/Documents/estatistica-glpi/relatorio_mensal/graficos/chamados_com_media_mensal_solucionado.png')
plt.savefig(f'/home/aleixo/Documents/pcantigo/Documents/estatistica-glpi/relatorio_mensal/graficos/chamados_com_media_mensal_solucionado_{labels}_{hoje.year}.png')
